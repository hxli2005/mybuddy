...
- 任务：S18.8 重写 README
- 提交：本提交
- 改动：README第一屏改为产品缘起、真实台词和她自己的生活；用read/walk/Raise、证据记忆、沉默零债务和四条红线说明差异，安装、源码运行、验收、打包与版权信息完整后置。
- 真实台词：README直接使用既有真实-key验收中显示过的“忙完啦？回来得正好，我正闲着。”“嗯？摸头干嘛，我又不是小猫。”“羁鸟恋旧林，池鱼思故渊……这两句读得人心口软了一下。”
- 验证：DESIGN与使用说明相对链接有效，Markdown diff检查通过；仅文档与任务板变化，未修改运行代码。
- 阻塞：S18真实基线前仍须覆盖raise措辞“检查我还在不在？”这一用户动机猜测。
- 她哪里更活了：代码没有变；README终于先让人看见她怎样生活、怎样说话，而不是先看见接口和文件名。
