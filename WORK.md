...
- 任务：S18.2 栖边模式
- 提交：本提交
- 闭环：拖到左右工作区边缘后，窗口只露 144 DIP 并切换对应 SideHide baseline；悬停 350ms 才播放本地 Rise，点击、托盘双击或托盘设置主动展开；侧边与高度可重启恢复
...
- 本刀实际台词：无——栖边全程不产生也不确认表达，这是“默默陪伴”的验收结果；最近一条真实-key shown 仍是“你把我提起来又放下了。”
- 回归：Python 82 passed，BuddyShell 12 passed，仓库结构 3 passed，Ruff/format 全绿；机器侧 4969 行；分享包 125.8 MiB、294 帧，其中 Normal SideHide 77 帧/11 MiB，授权文件仍在
- 产物：dist/MyBuddy-win-x64.zip；稳定文件名不再跟内部施工编号漂移
- 她哪里更活了：她第一次能把完整身体收起来，留一小块会呼吸、会探头的存在感；安静不是消失，也没有被心智伪装成一段人生
